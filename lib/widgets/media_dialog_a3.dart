...
class MediaDialogA3 extends StatelessWidget {
  final Controller _controller;
  const MediaDialogA3({super.key, required Controller controller})
      : _controller = controller;

  @override
  Widget build(BuildContext context) {
    final av3 = _controller.av3;
    ...
    final av2Peso = av2! * 6;
    final av3Peso = av3! * 6;
    final mediaAv2 = (av1Peso+av2Peso)/10;
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Math.tex('Ava1 = ${ava1?.toStringAsFixed(2)}',
                            mathStyle: MathStyle.text),
                        Math.tex('Ava2 = ${ava2?.toStringAsFixed(2)}',
                            mathStyle: MathStyle.text),
                        Math.tex('A2 = ${av2.toStringAsFixed(2)}',
                            mathStyle: MathStyle.text),
                        Math.tex('A3 = ${av3.toStringAsFixed(2)}',
                            mathStyle: MathStyle.text),
                      ],
                    ),
                    const SizedBox(
                    ...
                    Math.tex('A1 = \\frac{ $ava1 + $ava2}{2} = $av1',
                    ...
                    Math.tex('M= \\frac{ $av1 \\cdot 4 + $av2 \\cdot 6 }{10}',
                        mathStyle: MathStyle.display),
                    const SizedBox(
                      height: 25,
                    ),
                    Math.tex(
                        'M = \\frac{ $av1Peso + $av2Peso }{10} = ${mediaAv2.toStringAsFixed(2)}',
                        mathStyle: MathStyle.display),
                    Padding(
                      padding: const EdgeInsets.symmetric(vertical: 8),
                      child: Text(
                        'A nota A3 serve como substituta da A2, recalculando a média.',
                        textAlign: TextAlign.center,
                        style: GoogleFonts.roboto(fontWeight: FontWeight.bold),
                      ),
                    ),
                    ...
                    Math.tex('M= \\frac{ $av1 \\cdot 4 + $av3 \\cdot 6 }{10}',
                        mathStyle: MathStyle.display),
                    const SizedBox(
                      height: 25,
                    ),
                    Math.tex(
                        'M = \\frac{ $av1Peso + $av3Peso }{10} = ${media.toStringAsFixed(2)}',
                        mathStyle: MathStyle.display),
                  ],
                ),
              ),
